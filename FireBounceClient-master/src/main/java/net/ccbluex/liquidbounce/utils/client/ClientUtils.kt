...
object ClientUtils : MinecraftInstance {
    ...
    val LOGGER: Logger = LogManager.getLogger("FireBounce")
    ...
    fun displayChatMessage(message: String) {
        mc.thePlayer?.addChatMessage(ChatComponentText("§8[§c§lF§6§li§e§lr§a§le§b§lB§d§lo§9§lu§5§ln§c§lc§6§le§8]§r $message"))
