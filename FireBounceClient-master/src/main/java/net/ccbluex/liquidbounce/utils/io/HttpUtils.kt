...
/**
 * User agent
 * FireBounce/<version> (<commit>, <branch>, <build-type>, <platform>)
 */
val DEFAULT_AGENT =
    "FireBounce/${FireBounce.clientVersionText} (${FireBounce.clientCommit}, ${FireBounce.clientBranch}, ${if (FireBounce.IN_DEV) "dev" else "release"}, ${System.getProperty("os.name")})"
