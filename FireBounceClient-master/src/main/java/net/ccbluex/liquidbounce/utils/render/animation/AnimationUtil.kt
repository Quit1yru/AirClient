...
object AnimationUtil {
    ...
    fun easeInOutBack(t: Double, b: Double, c: Double, d: Double): Double {
        var t = t
        var s = 1.70158
        t /= d / 2
        if (t < 1) {
    ...
    fun easeInExpo(t: Double, b: Double, c: Double, d: Double): Double {
        return if (t == 0.0) b else c * 2.0.pow(10 * (t / d - 1)) + b
    }

    fun easeOutExpo(t: Double, b: Double, c: Double, d: Double): Double {
        return if (t == d) b + c else c * (-2.0.pow(-10 * t / d) + 1) + b
    }
    ...
    fun easeInOutExpo(t: Double, b: Double, c: Double, d: Double): Double {
        ...
        if (t == d) return b + c
        t /= d / 2
        if (t < 1) return c / 2 * 2.0.pow(10 * (t - 1)) + b
        t--
        return c / 2 * (-2.0.pow(-10 * t) + 2) + b
    }
    ...
    fun easeInOutBounce(t: Double, b: Double, c: Double, d: Double): Double {
        if (t < d / 2) return easeInBounce(t * 2, 0.0, c, d) * 0.5 + b
