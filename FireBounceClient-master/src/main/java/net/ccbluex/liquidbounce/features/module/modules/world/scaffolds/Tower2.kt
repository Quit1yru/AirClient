...
import net.ccbluex.liquidbounce.features.module.modules.world.scaffolds.Scaffold2.searchMode
import net.ccbluex.liquidbounce.features.module.modules.world.scaffolds.Scaffold2.shouldGoDown
import net.ccbluex.liquidbounce.utils.block.block
import net.ccbluex.liquidbounce.utils.client.MinecraftInstance
import net.ccbluex.liquidbounce.utils.client.PacketUtils.sendPackets
import net.ccbluex.liquidbounce.utils.extensions.isMoving
import net.ccbluex.liquidbounce.utils.extensions.tryJump
import net.ccbluex.liquidbounce.utils.extra.MovementUtils.isBlockUnder
...
object Tower2 : Configurable("Tower2"), MinecraftInstance, Listenable {
    ...
    val onMotion = handler<MotionEvent> { event ->
        ...
        if (eventState == EventState.POST) {
            ...
            if (blockPos.block == air) {
                Scaffold2.search(blockPos, !shouldGoDown, searchMode == "Area")
            }
        }
    }
    ...
    val onJump = handler<JumpEvent> { event ->
        if (onJumpValues.get()) {
            if (Scaffold2.scaffoldMode == "GodBridge" && (Scaffold2.jumpAutomatically) || !Scaffold2.shouldJumpOnInput)
                return@handler
    ...
    override fun handleEvents() = Scaffold2.handleEvents()
}
