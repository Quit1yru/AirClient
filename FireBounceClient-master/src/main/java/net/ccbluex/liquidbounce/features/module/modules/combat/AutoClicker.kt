...
object AutoClicker : Module("AutoClicker", Category.COMBAT) {
    ...
    private val leftMode by choices("LeftMode", arrayOf("RNG", "Record1", "Record2", "Record3", "Butterfly", "Jitter", "ConstantMiddle", "ConstGenerate", "ConstGenerate2", "Extra"), "RNG")
    private val leftCPS by intRange("LeftCPS", 15..20, 1..200) { left }
    private val rightMode by choices("RightMode", arrayOf("RNG", "Record1", "Record2", "Record3", "Butterfly", "Jitter", "ConstantMiddle", "ConstGenerate", "ConstGenerate2", "Extra"), "RNG")
    private val rightCPS by intRange("RightCPS", 15..20, 1..200) { right }
    private fun generateLeftClickTime() = randomClickDelay(leftCPS.first, leftCPS.last, leftMode)
    private fun generateRightClickTime() = randomClickDelay(rightCPS.first, rightCPS.last, rightMode)
    ...
    private var rightDelay = generateLeftClickTime()
    private var rightLastSwing = 0L
    private var leftDelay = generateRightClickTime()
    ...
    private fun handleLeftClick(time: Long, doubleClick: Int) {
        ...
        repeat(1 + doubleClick) {
            ...
            leftLastSwing = time
            leftDelay = generateLeftClickTime()
        }
    }
    ...
    private fun handleRightClick(time: Long, doubleClick: Int) {
        repeat(1 + doubleClick) {
            ...
            rightLastSwing = time
            rightDelay = generateRightClickTime()
        }
    }
