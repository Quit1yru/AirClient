...
import net.ccbluex.liquidbounce.features.module.modules.movement.longjumpmodes.matrix.Matrix
...
object LongJump : Module("LongJump", Category.MOVEMENT) {
    ...
    private val longJumpModes = arrayOf(
        ...
        // Other
        Redesky, Hycraft, Buzz, VerusDamage, KKCraft,
    )
    ...
    // Matrix模式专用设置
    val matrixBypassMethod by choices("Matrix-BypassMethod", arrayOf("Fall", "NoGround"), "Fall") { mode == "Matrix" }
    val matrixBoostSpeed by float("Matrix-BoostSpeed", 2.1f, -3f..8f) { mode == "Matrix" }
    ...
    // Matrix模式专用变量
    var matrixReceivedFlag = false
    var matrixCanBoost = false
    var matrixBoosted = false
    var matrixTouchGround = false
    ...
    override fun onEnable() {
        matrixReceivedFlag = false
        matrixCanBoost = false
        matrixBoosted = false
        matrixTouchGround = false
