...
object SnakeGame : Module("SnakeGame", Category.FUN, gameDetecting = false) {
    ...
    val onRender2D = handler<Render2DEvent> {
        ...
        // Draw score text
        Bold36.drawStringWithShadow("Score: §a$score", sx, sy - 14f, Color(220, 220, 220).rgb)

        // Draw high score box
        val hsText = "High Score: §a$highScore"
        val hsTextWidth = Bold36.getStringWidth(hsText)
        val hsTextHeight = Bold36.FONT_HEIGHT
        val hsX1 = sx.toInt()
        ...
        Bold36.drawStringWithShadow(hsText, (hsX1 + 3).toFloat(), (hsY1 + 2).toFloat(), Color(220, 220, 220).rgb)

        // Draw current mode indicator
        Bold36.drawStringWithShadow(
            "mode: $mode",
            sx + FIELD_WIDTH - 50,
            sy - 14f,
