...
object Aimbot : Module("Aimbot", Category.COMBAT) {
    ...
    private val legitimizeFactor by floatRange("LegitimizeFactor", 0.9f..1.1f) { horizontalAim || verticalAim }
    ...
    private fun findRotation(entity: Entity, random: Random): Boolean {
        ...
        val boundingBox: AxisAlignedBB? = entity.hitBox.offset(prediction)
        ...
        val rotation = performAngleChange(
            ...
            legitimizeFactor = legitimizeFactor,
