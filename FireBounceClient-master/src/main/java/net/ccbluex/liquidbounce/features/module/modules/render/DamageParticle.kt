 ...
 * https://github.com/FireFlyUnegit/FireBounceClient/
 */
...
object DamageParticle : Module("DamageParticle", Category.RENDER) {
    ...
    private val healthIcon by boolean("HealthIcon", false)
