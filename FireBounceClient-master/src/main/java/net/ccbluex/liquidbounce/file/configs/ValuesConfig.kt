...
import net.ccbluex.liquidbounce.FireBounce.commandManager
...
class ValuesConfig(file: File) : FileConfig(file) {
    ...
    override fun loadConfig() {
        ...
        if (prevVersion != FireBounce.clientVersionText) {
            // Run backup
            FileManager.backupAllConfigs(prevVersion, FireBounce.clientVersionText)
        }
    ...
    override fun saveConfig() {
        ...
        jsonObject.run {
            ...
            addProperty("ClientVersion", FireBounce.clientVersionText)
        }
