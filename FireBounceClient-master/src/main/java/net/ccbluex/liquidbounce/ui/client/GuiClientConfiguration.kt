...
import net.ccbluex.liquidbounce.FireBounce.background
...
class GuiClientConfiguration(val prevGui: GuiScreen) : AbstractScreen() {
    ...
    override fun initGui() {
        ...
        altPrefixField = GuiTextField(2, Fonts.Bold36, width / 2 - 100, height / 4 + 260 + 25, 200, 20)
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        if (altPrefixField.text.isEmpty() && !altPrefixField.isFocused) {
            Fonts.Bold36.drawStringWithShadow(
                ...
                altPrefixField.yPosition + (altPrefixField.height - Fonts.Bold36.FONT_HEIGHT) / 2F,
                0xffffff
            )
        }
