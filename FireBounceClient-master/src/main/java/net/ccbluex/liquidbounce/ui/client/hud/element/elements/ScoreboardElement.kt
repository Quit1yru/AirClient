...
import net.ccbluex.liquidbounce.FireBounce.CLIENT_WEBSITE
...
class ScoreboardElement(
    ...
    private val serverIp by choices("ServerIP", arrayOf("Normal", "None", "Client", "Website","Custom"), "Normal")
    private val customText by text("CustomText", "") {serverIp == "Custom"}
    ...
    private val shadowStrengh by float("ShadowStrength", 1.0f, 0.1f..2.0f) { ShadowCheck }
    ...
    override fun drawElement(): Border? {
        assumeNonVolatile {
            ...
            withClipping(main = {
                ...
                ShowShadow(minX.toFloat(), -(4 + inc).toFloat(), (maxX - minX).toFloat(), (maxHeight + fontHeight + 2 + 4 + inc).toFloat())
            }, toClip = {
                            ...
                            runCatching {
                                if (nameWithoutFormatting?.lowercase() == trimmedServerIP || containsDomain) {
                                    ...
                                    name = when (serverIp.lowercase()) {
                                        ...
                                        "website" -> "$colorCode FireBounce.today"
                                        "custom" -> customText
                                        else -> return null
                                    }
                                }
