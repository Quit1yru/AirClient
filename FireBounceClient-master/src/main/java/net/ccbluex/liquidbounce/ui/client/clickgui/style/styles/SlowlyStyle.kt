...
object SlowlyStyle : Style() {
    override fun drawPanel(mouseX: Int, mouseY: Int, panel: Panel) {
        ...
        val xPos = panel.x - (Bold36.getStringWidth("§f" + StringUtils.stripControlCodes(panel.name)) - 100) / 2
        Bold36.drawString(panel.name, xPos, panel.y + 2, Color.WHITE.rgb)
    }
    ...
    override fun drawHoverText(mouseX: Int, mouseY: Int, text: String) {
        ...
        lines.forEachIndexed { index, text ->
            Bold36.drawString(text, x + 12, y + 3 + (Bold36.fontHeight) * index, Color.WHITE.rgb)
        }
    }
    ...
    override fun drawButtonElement(mouseX: Int, mouseY: Int, buttonElement: ButtonElement) {
        ...
        Bold36.drawString(buttonElement.displayName, buttonElement.x + 5, buttonElement.y + 5, Color.WHITE.rgb)
    }
                ...
                for (value in moduleValues) {
                    ...
                    when (value) {
                        ...
                        is ListValue -> {
                            ...
                            if (mouseButton == 0 && mouseX in minX..maxX && mouseY in yPos..yPos + Bold36.fontHeight) {
                                value.openList = !value.openList
                                clickSound()
                                return true
                            }

                            Bold36.drawString(text, minX + 2, yPos + 2, Color.WHITE.rgb)
                            Bold36.drawString(
                            ...
                            yPos += Bold36.fontHeight + 1

                            for (valueOfList in value.values) {
                                moduleElement.settingsWidth = Bold36.getStringWidth("> $valueOfList") + 12
                        ...
                        is FloatValue -> {
                            ...
                            Bold36.drawString(text, minX + 2, yPos + 3, Color.WHITE.rgb)
                        ...
                        is FontValue -> {
                            ...
                            Bold36.drawString(displayString, minX + 2, yPos + 2, Color.WHITE.rgb)
                        ...
                        is ColorValue -> {
                            ...
                            if (value.showOptions) {
                                ...
                                rgbaLabels.forEachIndexed { index, label ->
                                    ...
                                    Bold36.drawString(defaultText, finalX, yPosition, Color.LIGHT_GRAY.rgb)
                            ...
                            chosenText?.let {
                                ...
                                if (it.selectionActive()) {
                                    val start = textX - 1 + Bold36.getStringWidth(input.take(it.selectionStart!!))
                            ...
                            if (shouldPushToRight) {
                                ...
                                Bold36.drawString(chosenText!!.string, textX, textY, Color.WHITE.rgb)
                                textX += valueWidth + 4
                            }
