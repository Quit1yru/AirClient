...
import net.ccbluex.liquidbounce.FireBounce.clientRichPresence
...
class GuiModsMenu(private val prevGui: GuiScreen) : AbstractScreen() {
    ...
    override fun initGui() {
        ...
        customTextField = GuiTextField(2, Fonts.Bold36, width / 2 - 100, height / 4 + 48 + 190, 200, 20)
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        if (customTextField.text.isEmpty() && !customTextField.isFocused) {
            Fonts.Bold36.drawStringWithShadow(
                clientRichPresence.customRPCText.ifEmpty { translationMenu("discordRPC.typeBox") },
                customTextField.xPosition + 4f,
                customTextField.yPosition + (customTextField.height - Fonts.Bold36.FONT_HEIGHT) / 2F,
                0xffffff
            )
        }
