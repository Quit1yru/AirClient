...
object LiquidBounceStyle : Style() {
    override fun drawPanel(mouseX: Int, mouseY: Int, panel: Panel) {
        ...
        Bold36.drawString(panel.name, xPos, panel.y + 6, Color.WHITE.rgb)
    ...
    override fun drawHoverText(mouseX: Int, mouseY: Int, text: String) {
        ...
        val height = Bold36.fontHeight * lines.size + 3
        ...
        lines.forEachIndexed { index, text ->
            Bold36.drawString(text, x + 12, y + 3 + (Bold36.fontHeight) * index, Int.MAX_VALUE)
        }
    }
                ...
                for (value in moduleValues) {
                    ...
                    when (value) {
                        is BoolValue -> {
                            ...
                            moduleElement.settingsWidth = Bold36.getStringWidth(text) + 8
                        ...
                        is ListValue -> {
                            ...
                            moduleElement.settingsWidth = Bold36.getStringWidth(text) + 16
                            ...
                            Bold36.drawString("§c$text", minX + 2, yPos + 4, Color.WHITE.rgb)
                            Bold36.drawString(
                            ...
                            for (valueOfList in value.values) {
                                moduleElement.settingsWidth = Bold36.getStringWidth(valueOfList) + 16
                        ...
                        is FloatValue -> {
                            ...
                            Bold36.drawString(text, minX + 2, yPos + 4, Color.WHITE.rgb)
                        ...
                        is FontValue -> {
                            ...
                            moduleElement.settingsWidth = Bold36.getStringWidth(displayString) + 8
                            ...
                            Bold36.drawString(displayString, minX + 2, yPos + 4, Color.WHITE.rgb)
                        ...
                        is ColorValue -> {
                            ...
                            val optimalWidth = maxOf(Bold36.getStringWidth(combinedText), combinedWidth)
                            ...
                            if (mouseButton == 1 && mouseX in valueX..valueX + valueWidth && mouseY.toFloat() in textY - 2..textY + Bold36.height - 3F) {
                            ...
                            chosenText?.let {
                                ...
                                if (it.selectionActive()) {
                                    val start =
                                        startValueX + Bold36.getStringWidth(it.string.take(it.selectionStart!!))
                                    val end =
                                        startValueX + Bold36.getStringWidth(it.string.take(it.selectionEnd!!))
                                    drawRect(
                                        start,
                                        cursorY - 3f,
                                        end,
                        ...
                        is MultiChoiceValue -> {
                            ...
                            for (choice in value.choices) {
                                moduleElement.settingsWidth = maxOf(
                                    ...
                                    Bold36.getStringWidth(choice) + 16
                                )
                            ...
                            val combinedWidth = Bold36.getStringWidth(startText + valueText)

                            moduleElement.settingsWidth = combinedWidth + 8

                            val textY = yPos + 4
                            val startX = minX + 2
                            var textX = startX + Bold36.getStringWidth(startText)

                            // Draw hover effect
                            if (mouseX in minX..maxX && mouseY in textY - 2..textY + Bold36.fontHeight) {
                                drawRect(minX, textY - 2, maxX, textY + Bold36.fontHeight, Color(255, 255, 255, 30).rgb)
                            }

                            if (mouseButton == 0) {
                                chosenText =
                                    if (mouseX in textX..maxX && mouseY in textY - 2..textY + 6) {
                                        when (value) {
                                            is TextValue -> EditableText.forTextValue(value)
                                            is IntValue -> EditableText.forIntValue(value)
                                            is FloatValue -> EditableText.forFloatValue(value)
                                            else -> null
                                        }
                                    } else {
                                        null
                            ...
                            val shouldPushToRight =
                                (value is TextValue || value is IntValue || value is FloatValue) && 
                                chosenText?.value == value && chosenText?.string != value.get().toString()
                            ...
                            chosenText?.let {
                                ...
                                if (it.selectionActive()) {
                                    val start =
                                        textX - 1 + Bold36.getStringWidth(input.take(it.selectionStart!!))
                                    val end = textX - 1 + Bold36.getStringWidth(input.take(it.selectionEnd!!))
                                    drawRect(
                                        start,
                                        textY - 3,
                                        end,
                                        textY + Bold36.fontHeight - 2,
                                        Color(7, 152, 252).rgb
                                    )
                                }

                                highlightCursor = { textX ->
                                    val cursorX = textX + Bold36.getStringWidth(input.take(it.cursorIndex))
                                    drawRect(
                                        cursorX,
                                        textY - 3,
                                        cursorX + 1,
                            ...
                            Bold36.drawString(startText, startX, textY, Color.WHITE.rgb)
                            ...
                            if (shouldPushToRight) {
                                ...
                                Bold36.drawString(chosenText!!.string, textX, textY, minecraftRed.rgb)
                                textX += valueWidth + 4
                            }

                            Bold36.drawString(valueText, textX, textY, defaultColor.rgb)
