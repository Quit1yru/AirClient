...
import net.ccbluex.liquidbounce.FireBounce.IN_DEV
import net.ccbluex.liquidbounce.FireBounce.clientVersionNumber
...
object ClientUpdate {
    ...
    val gitInfo = Properties().also {
        val inputStream = FireBounce::class.java.classLoader.getResourceAsStream("git.properties")
